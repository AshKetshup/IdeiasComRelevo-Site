<?php
    ...
    class ContactManagement {
        ...
        public function get_contacts() {            
            ...
            $aboutUs = ContactsEntity::fromType('aboutus')->get_value();
            return array(
                "office" => $office,
                "phone" => $phone,
                "email" => $email,
